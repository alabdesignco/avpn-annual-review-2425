const countries = [
  ...
  "Cocos Islands", "Colombia", "Comoros", "Congo", "Congo, Democratic Republic of the", "Cook Islands", 
  "Costa Rica", "Croatia", "Cuba", "Curaçao", "Cyprus", "Czechia", "Côte d'Ivoire", "Denmark", 
  ...
  "Réunion", "Saint Barthélemy", "Saint Helena, Ascension and Tristan da Cunha", "Saint Kitts and Nevis", 
  ...
  "Taiwan", "Tajikistan", "Tanzania, the United Republic of", "Thailand", "Timor-Leste", "Togo", 
  "Tokelau", "Tonga", "Trinidad and Tobago", "Tunisia", "Turkmenistan", "Turks and Caicos Islands", 
...
export const initCountrySelect = () => {
  const selectField = document.getElementById('Market');
  
  if (!selectField) return;

  selectField.innerHTML = '<option value="">Select your market...</option>';
